...
export default function InventoryReasonsPage({ params }: { params: Promise<{ tenantId: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle={loading ? '…' : `${total} reason${total !== 1 ? 's' : ''}`}
        actions={[{ label: <><FontAwesomeIcon icon={faPlus} /> New Reason</>, onClick: openCreate }]}
      />
