  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={[
          { label: <FontAwesomeIcon icon={faGear} />, href: `/tenant/${tenantId}/admin/inventory/stock/settings`, variant: 'ghost' as const },
          { label: <><FontAwesomeIcon icon={faPlus} /> New Stock Item</>, onClick: openCreate },
        ]}
      />
