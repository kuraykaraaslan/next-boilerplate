...
export function UomsPanel({ tenantId }: { tenantId: string }) {
  ...
  return (
    <div className="space-y-4">
      ...
      <ServerDataTable
        ...
        headerRight={<Button variant="primary" size="sm" onClick={openCreate}><FontAwesomeIcon icon={faPlus} /> New Unit</Button>}
        toolbar={
          <div className="pb-4">
