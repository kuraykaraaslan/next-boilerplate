...
/** POST /tenant/[tenantId]/api/payments/[paymentId]/fail — PENDING|PROCESSING -> FAILED. */
export async function POST(request: NextRequest, { params }: Ctx) {
  ...
  try {
    ...
    const item = await PaymentService.fail(tenantId, paymentId, body?.failureCode, body?.failureMessage);
