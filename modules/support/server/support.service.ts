...
import type { CreateTicketDTO, ListTicketsQuery, ReplyTicketDTO } from './support.dto';
import type { TicketStatus } from './support.enums';
import { allocateTicketNumber, getNextTicketNumber } from './support.numbering';
import { createTicket, reply } from './support.write.service';
import { assign, setStatus, resolve, close } from './support.lifecycle.service';
import { list, get } from './support.read.service';

/**
 * Support-ticket service facade. The implementation is split across focused
 * modules (`support.write.service`, `.lifecycle.service`,
