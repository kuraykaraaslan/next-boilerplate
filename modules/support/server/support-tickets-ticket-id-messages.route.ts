...
import { SupportTicketService, ReplyTicketDTO } from '@kuraykaraaslan/support';

/**
 * POST /tenant/[tenantId]/api/support/tickets/[ticketId]/messages
...
export async function POST(
  ...
  try {
    ...
    return NextResponse.json({ message: await SupportTicketService.reply(tenantId, parsed.data) }, { status: 201 });
  } catch (error: unknown) {
