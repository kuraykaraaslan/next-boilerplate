  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        actions={[
          { label: <FontAwesomeIcon icon={faGear} />, href: `/tenant/${tenantId}/admin/accounting/periods/settings`, variant: 'ghost' as const },
          { label: <><FontAwesomeIcon icon={faPlus} /> New Period</>, onClick: openCreate },
        ]}
      />
