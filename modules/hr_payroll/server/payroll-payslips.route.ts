...
export async function POST(request: NextRequest, { params }: { params: Promise<{ tenantId: string }> }) {
  ...
  try {
    const dto = CreatePayslipDTO.parse(await request.json())
    const item = await PayslipService.create(tenantId, dto)
