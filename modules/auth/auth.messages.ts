export enum AuthMessages {
    ...
    PASSWORD_CONTAINS_IDENTITY = "PASSWORD_CONTAINS_IDENTITY",
    PASSWORD_HAS_SEQUENTIAL_OR_REPEATED = "PASSWORD_HAS_SEQUENTIAL_OR_REPEATED",
