...
import BasePaymentProvider from '@nb/payment_core/server/providers/base.provider'
import StripeProvider from '@nb/payment_core/server/providers/stripe.provider'
import PaypalProvider from '@nb/payment_core/server/providers/paypal.provider'
import IyzicoProvider from '@nb/payment_core/server/providers/iyzico.provider'
import AlipayProvider from '@nb/payment_core/server/providers/alipay.provider'
import WeChatPayProvider from '@nb/payment_core/server/providers/wechatpay.provider'
import YooKassaProvider from '@nb/payment_core/server/providers/yookassa.provider'
import CloudPaymentsProvider from '@nb/payment_core/server/providers/cloudpayments.provider'
