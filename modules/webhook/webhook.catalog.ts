...
export const WEBHOOK_EVENT_CATALOG: Record<WebhookEvent, WebhookEventMeta> = {
  ...
  'gift_card.issued':       { scope: 'tenant', group: 'Gift Cards',    label: 'Gift card issued',      description: 'A gift card was issued.' },
  'gift_card.redeemed':     { scope: 'tenant', group: 'Gift Cards',    label: 'Gift card redeemed',    description: 'A gift card was redeemed (fully or partially) into a wallet.' },
  'gift_card.voided':       { scope: 'tenant', group: 'Gift Cards',    label: 'Gift card voided',      description: 'A gift card was voided and its remaining balance forfeited.' },
  'gift_card.expired':      { scope: 'tenant', group: 'Gift Cards',    label: 'Gift card expired',     description: 'A gift card passed its expiry date and was deactivated by the expiry sweep.' },
  'integration.connected':     { scope: 'tenant', group: 'Integrations', label: 'Integration connected',     description: 'A third-party connector was connected.' },
  'integration.disconnected':  { scope: 'tenant', group: 'Integrations', label: 'Integration disconnected',  description: 'A third-party connector was disconnected.' },
  'integration.trigger_fired': { scope: 'tenant', group: 'Integrations', label: 'Integration trigger fired', description: 'An outbound integration trigger fired (carries the connector + event key).' },
  'integration.error':         { scope: 'tenant', group: 'Integrations', label: 'Integration error',         description: 'An integration trigger or action failed.' },
  ...
  'approval.submitted': { scope: 'tenant', group: 'Approval', label: 'Approval submitted',    description: 'An item was submitted to the moderation / approval queue.' },
  'approval.approved':  { scope: 'tenant', group: 'Approval', label: 'Approval approved',     description: 'A queued item was approved by a reviewer.' },
  'approval.rejected':  { scope: 'tenant', group: 'Approval', label: 'Approval rejected',     description: 'A queued item was rejected by a reviewer.' },
  'approval.escalated': { scope: 'tenant', group: 'Approval', label: 'Approval escalated',    description: 'A queued item was escalated by a reviewer.' },
  'support.ticket.created':     { scope: 'tenant', group: 'Support', label: 'Support ticket created', description: 'A new support ticket was opened.' },
  'support.ticket.replied':     { scope: 'tenant', group: 'Support', label: 'Support ticket reply',  description: 'A reply was posted to a support ticket.' },
  'support.ticket.resolved':    { scope: 'tenant', group: 'Support', label: 'Support ticket resolved', description: 'A support ticket was resolved or closed.' },
