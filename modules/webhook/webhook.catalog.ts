...
export const WEBHOOK_EVENT_CATALOG: Record<WebhookEvent, WebhookEventMeta> = {
  ...
  'back_office.approval.submitted': { scope: 'tenant', group: 'Back-Office', label: 'Approval submitted',    description: 'An item was submitted to the moderation / approval queue.' },
  'back_office.approval.approved':  { scope: 'tenant', group: 'Back-Office', label: 'Approval approved',     description: 'A queued item was approved by a reviewer.' },
  'back_office.approval.rejected':  { scope: 'tenant', group: 'Back-Office', label: 'Approval rejected',     description: 'A queued item was rejected by a reviewer.' },
  'back_office.approval.escalated': { scope: 'tenant', group: 'Back-Office', label: 'Approval escalated',    description: 'A queued item was escalated by a reviewer.' },
  'back_office.ticket.created':     { scope: 'tenant', group: 'Back-Office', label: 'Support ticket created', description: 'A new support ticket was opened.' },
  'back_office.ticket.replied':     { scope: 'tenant', group: 'Back-Office', label: 'Support ticket reply',  description: 'A reply was posted to a support ticket.' },
  'back_office.ticket.resolved':    { scope: 'tenant', group: 'Back-Office', label: 'Support ticket resolved', description: 'A support ticket was resolved or closed.' },
