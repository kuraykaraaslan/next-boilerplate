...
Pluggable S3-compatible file storage (AWS S3, Cloudflare R2, DigitalOcean Spaces, MinIO).
...
- `system` GET/POST/DELETE `/system/api/storage`
- `system` POST `/system/api/storage/from-url`
