...
- `SupportTicket` (system) — `modules/support/entities/support_ticket.entity.ts`
- `SupportTicketMessage` (system) — `modules/support/entities/support_ticket_message.entity.ts`
