...
- `system` GET/POST `/system/api/admin/payments`
- `system` GET/PUT/DELETE `/system/api/admin/payments/[paymentId]`
- `system` POST `/system/api/admin/payments/[paymentId]/refund`
- `system` GET/POST `/system/api/admin/payments/[paymentId]/transactions`
- `system` POST `/system/api/admin/payments/provider-status`
- `system` GET `/system/api/admin/payments/providers`
- `system` GET/PUT `/system/api/admin/payments/transactions/[transactionId]`
