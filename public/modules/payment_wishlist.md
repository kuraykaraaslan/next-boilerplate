...
- `WishlistItem` (system) — `modules/payment_wishlist/server/entities/wishlist_item.entity.ts`
- `WishlistPricePoint` (system) — `modules/payment_wishlist/server/entities/wishlist_price_point.entity.ts`
