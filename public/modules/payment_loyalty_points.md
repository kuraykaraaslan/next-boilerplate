...
- `LoyaltyAccount` (system) — `modules/payment_loyalty_points/entities/loyalty_account.entity.ts`
- `LoyaltyTier` (system) — `modules/payment_loyalty_points/entities/loyalty_tier.entity.ts`
- `LoyaltyTransaction` (system) — `modules/payment_loyalty_points/entities/loyalty_transaction.entity.ts`
