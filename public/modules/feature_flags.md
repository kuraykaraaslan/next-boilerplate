...
- `FeatureFlag` (system) — `modules/feature_flags/entities/feature_flag.entity.ts`
- `FeatureFlagOverride` (system) — `modules/feature_flags/entities/feature_flag_override.entity.ts`
