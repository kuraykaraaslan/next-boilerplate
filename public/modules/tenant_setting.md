...
- **tier:** tenancy
- **version:** 1.0.0
- **dir:** `modules/tenant_setting/`
- **tags:** tenant, configuration
- **icon:** `fas fa-sliders`
- **hasNextLayer:** false

Per-tenant key-value settings store (overrides system defaults).
...
- `tenant_setting.service.ts`

## Entities

- `tenant_setting.entity.ts`

## TypeORM entities

- `TenantSetting` (tenant) — `modules/tenant_setting/entities/tenant_setting.entity.ts`
