...
- **tier:** other
- **version:** 1.0.0
- **dir:** `modules/payment_shipping/`
- **tags:** payment, shipping, ecommerce
- **icon:** `fas fa-truck`
- **hasNextLayer:** false

Tenant-aware shipping methods and a rate-calculation engine. Define carriers and rate rules (by country, region, weight, subtotal) and compute shipping quotes at checkout.
...
- `ShippingMethod` (system) — `modules/payment_shipping/entities/shipping_method.entity.ts`
- `ShippingRate` (system) — `modules/payment_shipping/entities/shipping_rate.entity.ts`
