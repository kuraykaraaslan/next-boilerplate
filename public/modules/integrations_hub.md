...
- `ConnectedApp` (system) — `modules/integrations_hub/entities/connected_app.entity.ts`
- `Connector` (system) — `modules/integrations_hub/entities/connector.entity.ts`
- `IntegrationEvent` (system) — `modules/integrations_hub/entities/integration_event.entity.ts`
- `OAuthToken` (system) — `modules/integrations_hub/entities/oauth_token.entity.ts`
