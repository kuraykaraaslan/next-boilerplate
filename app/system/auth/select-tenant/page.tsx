...
export default function SelectTenantPage() {
  ...
  useEffect(() => {
    Promise.all([
      api.get('/system/api/auth/session'),
      api.get('/system/api/auth/me/tenants'),
    ])
  ...
  function handleSelect(tenantId: string) {
    ...
    window.location.href = `/tenant/${tenantId}/admin/members`;
  }
  ...
  async function handleCreate(e: React.FormEvent) {
    ...
    setCreateError('');
    try {
      const res = await api.post('/system/api/tenants/create', {
